...
def exercise01():
    ...
    arbData = {'Name':["Alice","Armensilo","Appalite","Arzarth","Alixedor"],
               "Age":[48,50,22,35,19]}
    df1 = pd.DataFrame(arbData)
...
def exercise04():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df4 = pd.DataFrame([{'city': 'New York', 'data': 1000},
    {'city': 'Los Angeles', 'data': 2000},
    {'city': 'Chicago', 'data': 1500}])
